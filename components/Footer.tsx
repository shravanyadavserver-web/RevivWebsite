  ...
  return (
    <footer id="footer" className="bg-primary text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-blue-100 leading-relaxed">
              The Only Global Leader In IV Drip Therapy And Vitamin Shots.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#book-appointment" className="text-sm text-blue-100 hover:text-white transition-colors">
                  Register Now
                </a>
              </li>
            </ul>
      ...
      <div className="border-t border-white/20">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-16 py-4 flex flex-col sm:flex-row justify-between items-center gap-2">
          <p className="text-xs text-blue-200">
            &copy; {new Date().getFullYear()} REVIV Hyderabad. All rights reserved.
          </p>
          <a
            href="/privacy-policy"
